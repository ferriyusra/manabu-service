...
const docTemplate = `{
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "description": "Filter by Question Type (multiple_choice, fill_blank, matching, listening, speaking)",
                        "name": "questionType",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        "type": "string",
                        "example": "\"hiragana\"",
                        "description": "Search in question text and explanation",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        ...
                        "default": "order_index",
                        "example": "\"order_index\"",
                        "description": "Sort by field (order_index, question_text, created_at, points)",
                        "name": "sortBy",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ExerciseQuestionListSwaggerResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateExerciseQuestionRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/dto.ExerciseQuestionSwaggerResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                    ...
                    "409": {
                        "description": "Question with this order_index already exists for this exercise",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    "422": {
                        "description": "Invalid exercise ID, question type, points, or order_index",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/exercise-questions/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Exercise Question ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateExerciseQuestionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.PublishExerciseQuestionRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Question is already in the requested state",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/dto.ExerciseQuestionPublicResponse"
                                            }
                                        }
                                    }
                                }
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "example": "\"last_accessed_at\"",
                        "description": "Sort by field (last_accessed_at, progress_percentage, started_at)",
                        "name": "sortBy",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.UserCourseProgressListSwaggerResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateUserCourseProgressRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/dto.UserCourseProgressSwaggerResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/user-course-progress/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "format": "uuid",
                        "description": "User Course Progress UUID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "User course progress not found",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateUserCourseProgressRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Cannot update completed course",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    ...
                    "422": {
                        "description": "Invalid completed lessons count",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
    ...
    "definitions": {
        ...
        "dto.CreateExerciseQuestionRequest": {
            "type": "object",
            "required": [
                "correctAnswer",
                "exerciseId",
            ...
            "properties": {
                ...
                "explanation": {
                    "type": "string",
                    "maxLength": 1000,
                    "example": "The Hiragana character for 'a' is あ"
                },
                "imageUrl": {
                    "type": "string",
                    "maxLength": 500,
                ...
                "questionText": {
                    ...
                    "maxLength": 1000,
                    "minLength": 3,
                    "example": "What is the correct Hiragana for 'a'?"
                },
                "questionType": {
                    "type": "string",
                    "enum": [
        ...
        "dto.CreateUserCourseProgressRequest": {
            "type": "object",
            "required": [
                "courseId"
            ],
        ...
        "dto.ExerciseQuestionListSwaggerResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.ExerciseQuestionResponse"
                    }
                },
                "message": {
                    "type": "string",
                    "example": "Exercise questions retrieved successfully"
                },
                "pagination": {
                    "$ref": "#/definitions/dto.PaginationResponse"
                },
        ...
        "dto.ExerciseQuestionPublicResponse": {
            "type": "object",
            "properties": {
                "audioUrl": {
                    "type": "string",
        ...
        "dto.ExerciseQuestionSwaggerResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.ExerciseQuestionResponse"
                ...
                "message": {
                    "type": "string",
                    "example": "Exercise question created successfully"
                },
                "status": {
                    "type": "string",
                    "example": "success"
        ...
        "dto.PublishExerciseQuestionRequest": {
            "type": "object",
            "required": [
                "isPublished"
            ],
        ...
        "dto.UpdateExerciseQuestionRequest": {
            "type": "object",
            "required": [
                "correctAnswer",
                "exerciseId",
        ...
        "dto.UpdateUserCourseProgressRequest": {
            "type": "object",
            "required": [
                "completedLessons"
            ],
        ...
        "dto.UserCourseProgressListSwaggerResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                ...
                "message": {
                    "type": "string",
                    "example": "User course progress retrieved successfully"
                },
                "pagination": {
                    "$ref": "#/definitions/dto.PaginationResponse"
                },
        ...
        "dto.UserCourseProgressSwaggerResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.UserCourseProgressResponse"
                ...
                "message": {
                    "type": "string",
                    "example": "User course progress created successfully"
                },
                "status": {
                    "type": "string",
                    "example": "success"
